...
INNER JOIN mv_cursos_usuarios mcu ON miu.miu_user_id = mcu.mcu_user_id
...
INNER JOIN ma_identificacion_usuario miu ON miu.miu_user_id = map2.map_user_id 
...
INNER JOIN ma_identificacion_usuario miu ON mau.mau_user_id = miu.miu_user_id 
WHERE miu.miu_user_role IN ('APRENDIZ');
